...
##
execute positioned as @a if block ~1 ~ ~ potted_poppy run summon armor_stand ~1 ~1 ~ {Invisible:1,NoGravity:1,Tags:["potted_golem_as"],NoAI:true,Invulnerable:true}
execute positioned as @a if block ~-1 ~ ~ potted_poppy run summon armor_stand ~-1 ~1 ~ {Invisible:1,NoGravity:1,Tags:["potted_golem_as"],NoAI:true,Invulnerable:true}
execute positioned as @a if block ~ ~ ~1 potted_poppy run summon armor_stand ~ ~1 ~1 {Invisible:1,NoGravity:1,Tags:["potted_golem_as"],NoAI:true,Invulnerable:true}
execute positioned as @a if block ~ ~ ~-1 potted_poppy run summon armor_stand ~ ~1 ~-1 {Invisible:1,NoGravity:1,Tags:["potted_golem_as"],NoAI:true,Invulnerable:true}

execute positioned as @a if block ~1 ~1 ~ potted_poppy run summon armor_stand ~1 ~2 ~ {Invisible:1,NoGravity:1,Tags:["potted_golem_as"],NoAI:true,Invulnerable:true}
execute positioned as @a if block ~-1 ~1 ~ potted_poppy run summon armor_stand ~-1 ~2 ~ {Invisible:1,NoGravity:1,Tags:["potted_golem_as"],NoAI:true,Invulnerable:true}
execute positioned as @a if block ~ ~1 ~1 potted_poppy run summon armor_stand ~ ~2 ~1 {Invisible:1,NoGravity:1,Tags:["potted_golem_as"],NoAI:true,Invulnerable:true}
execute positioned as @a if block ~ ~1 ~-1 potted_poppy run summon armor_stand ~ ~2 ~-1 {Invisible:1,NoGravity:1,Tags:["potted_golem_as"],NoAI:true,Invulnerable:true}
...
execute as @e[tag=potted_golem_as,type=armor_stand] positioned as @s unless block ~ ~-1 ~ potted_poppy run kill @s
...
execute as @e[tag=potted_golem_as,type=armor_stand] positioned as @s unless entity @e[tag=potted_golem,distance=..1] run summon minecraft:iron_golem ~ ~ ~ {PlayerCreated:1,CustomName:'[{"text":"Protection Poppy"}]',CanPickUpLoot:1b,NoGravity:1b,PersistenceRequired:1b,Silent:1b,Tags:[potted_golem],DeathLootTable:"melononmain:entities/potted_golem"}
execute as @e[tag=potted_golem_as,type=armor_stand] positioned as @s if entity @e[tag=potted_golem,distance=..1] run tp @e[type=iron_golem,tag=potted_golem,sort=nearest,distance=..2] ~ ~ ~
